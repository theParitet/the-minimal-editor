...
export function Statuses({ statuses, handleImport, handleStatusesDelete }) {
  ...
  const placeholderJSX = (
    <p className='placeholder'>No imports yet...</p>
  );
  ...
  return (
    <div className='statuses-container'>
      <div className="statuses-container__controls">
        ...
        <input id="file-reader" onChange={handleImport} multiple={true} type="file" accept='text/*' />

        <button className='btn btn--default' onClick={handleStatusesDelete}>Clear</button>
      </div>
