export function Editor({ handleContentChange, handleTitleChange, titleRef, contentRef, file, isPanelCollapsed }) {
  ...
  return (
    <div className='editor-container'>
      <input
        ...
        value={noFileIsSelected ? 'Select or Create a File' : file?.title || ''} />
      <textarea
        id='editor__main'
        className={noFileIsSelected ? 'editor disabled' : 'editor'}
