            ...
            <div className='notification' key={record.description}>
                <div>
                    <h1 className='notification__title'>
                        {record.message} {
                            record.count !== 1 &&
                            <span className='notification__count'>{record.count}x</span>
                        }
                    </h1>
                    <p className='notification__description'>{record.description}</p>
                </div>
                <button className='btn-img btn-img--default notification__btn'
