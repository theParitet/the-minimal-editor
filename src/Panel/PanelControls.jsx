  ...
  return (
    <section className='panel__controls'>
      ...
      <div className='panel__controls__section'>
        <button className='btn-img btn-img--default' onClick={handleNewFile}>
          <img src={addFile} alt="Add file icon" />
        </button>
        <button className={!isCollapsed ? 'btn-img btn-img--default active' : 'btn-img btn-img--default'} onClick={handleCollapsed}>
      ...
      <div className='panel__controls__section'>
        ...
        <button className='btn-img btn-img--default' onClick={() => {
            handleSettings();
            setIsCollapsed(true);
          }}>
